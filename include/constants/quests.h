...
#define SUB_QUEST_DEFEAT_GENIES 1

#define SUB_QUEST_DEFEAT_BLUE 2
#define SUB_QUEST_DEFEAT_MAY 3
#define SUB_QUEST_DEFEAT_COOLTRAINER 4
#define SUB_QUEST_DEFEAT_YOUNGSTER 5
#define SUB_QUEST_DEFEAT_LEAF 6

#define SUB_QUEST_CATCH_TORNADUS 7
#define SUB_QUEST_CATCH_THUNDURUS 8

#define SUB_QUEST_SAVE_THE_LUVDISCS 9

#define SUB_QUEST_A_WHOLE_NEW_WORLD 10
...
#define SUB_QUEST_COUNT (QUEST_INVESTIGATE_PROSPERITY_SUB_COUNT + QUEST_FIND_THE_CULPRIT_SUB_COUNT + QUEST_CATCH_GENIES_SUB_COUNT + QUEST_SENTIMENTAL_SUB_COUNT + QUEST_WITH_MUCH_GRATITUDE_SUB_COUNT)
