...
void BattleSetup_StartLegendaryBattle(void)
{
    ...
    case SPECIES_TORNADUS:
        TRAINER_BATTLE_PARAM.opponentA = TRAINER_TORNADUS;
        TRAINER_BATTLE_PARAM.opponentB = TRAINER_NONE;
        CreateBattleStartTask(B_TRANSITION_MUGSHOT, MUS_BW_VS_LEGENDARY);
        break;
    case SPECIES_LANDORUS:
        TRAINER_BATTLE_PARAM.opponentA = TRAINER_LANDORUS;
        TRAINER_BATTLE_PARAM.opponentB = TRAINER_NONE;
        CreateBattleStartTask(B_TRANSITION_MUGSHOT, MUS_BW_VS_LEGENDARY);
        break;
    case SPECIES_ENAMORUS:
        TRAINER_BATTLE_PARAM.opponentA = TRAINER_ENAMORUS;
        TRAINER_BATTLE_PARAM.opponentB = TRAINER_NONE;
        CreateBattleStartTask(B_TRANSITION_MUGSHOT, MUS_BW_VS_LEGENDARY);
        break;
    case SPECIES_MEW:
...
void BattleSetup_StartLegendaryBattleDouble(void)
{
    ...
    case SPECIES_THUNDURUS:
    case SPECIES_TORNADUS:
        TRAINER_BATTLE_PARAM.opponentA = TRAINER_TORN_AND_THUND;
        TRAINER_BATTLE_PARAM.opponentB = TRAINER_NONE; // Set exclusively to create a mugshot
        CreateBattleStartTask(B_TRANSITION_MUGSHOT, MUS_BW_VS_LEGENDARY);
        break;
    }
