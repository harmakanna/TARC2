...
static const u8 sText_Someones[] = _("Looker's");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PLAYERWHITEOUT3]                      = COMPOUND_STRING("You hung your head in shame!{PAUSE_UNTIL_PRESS}"),
    ...
    [STRINGID_ABILITYWEAKENEDSURROUNDINGMONSSTAT]   = COMPOUND_STRING("{B_SCR_NAME_WITH_PREFIX}'s {B_SCR_ABILITY} weakened the {B_BUFF1} of all other Pokémon!\p"),
...
const u8 gText_OpponentLWillSwitch[] = _("{B_OPPONENT_MON2_NAME} switches\nto {B_BUFF3}"); 
...
const u8 gText_OpponentRWillSwitch[] = _("{B_OPPONENT_MON1_NAME} switches\nto {B_BUFF3}"); 
