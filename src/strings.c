...
const u8 gText_SideQuestName_7[] = _("Fish-stery");
...
const u8 gText_SideQuestDesc_7[] = _("Figure out the best place to fish!");
...
const u8 gText_SideQuestMap6[] = _("Map 6"); // Fish-stery
