...
const u8 gText_SideQuestName_17[] = _("Homegrown Remedies"); // Find ancient remedy
...
const u8 gText_SideQuestDesc_10[] = _("The farm's been overrun with PLACEHOLDER!");
const u8 gText_SideQuestDesc_11[] = _("Great, now the farm's been overrun\nwith PLACEHOLDER!");
const u8 gText_SideQuestDesc_12[] = _("The mother of all hordes has overrun\nthe farm!");
...
const u8 gText_SideQuestDoneDesc_10[] = _("The farm has been cleared of PLACEHOLDERs!");
