...
const u8 gText_SideQuestName_15[] = _("mmm, tasty mints!"); // Find tasty mint
...
const u8 gText_SideQuestDesc_15[] = _("no fair! i want a tasty mint!\nwhy do they grow every 100 years!");
...
const u8 gText_SideQuestDoneDesc_15[] = _("tasty yum yum tasty mints\nyummy tasty sweet and yummy");
