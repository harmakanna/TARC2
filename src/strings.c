...
const u8 gText_SideQuestDoneDesc_10[] = _("The farm has been cleared of those pesky\nrodents!");
const u8 gText_SideQuestDoneDesc_11[] = _("The farm has been cleared again! Maybe\nthey should get a guard dog?");
const u8 gText_SideQuestDoneDesc_12[] = _("And again! The farmer has been convinced\nto get a guard dog!");
