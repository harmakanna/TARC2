...
const u8 gText_SideQuestName_21[] = _("Break a Leg");
...
const u8 gText_SideQuestDoneDesc_20[] = _("Completed Quest 20"); // Inverse
const u8 gText_SideQuestDoneDesc_21[] = _("Completed Quest 21"); // Break a Leg
...
const u8 gText_SideQuestMap20[] = _("Present");
