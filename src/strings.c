...
const u8 gText_SideQuestName_9[] = _("Get Into the Groove"); // Find and battle idols
...
const u8 gText_SideQuestDesc_6[] = _("Hold a conversation with the French\ntourist!");
...
const u8 gText_SideQuestDesc_9[] = _("Where did Lisia's backup performers\ngo? The show's about to start!");
...
const u8 gText_SideQuestDoneDesc_9[] = _("The troupe is reunited and now feel\nconfident ahead of their shows!");
