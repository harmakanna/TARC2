...
const u8 gText_DadsAdvice[] = _("Hmm… Perhaps now is not the time or\nplace for this…{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SomeonesPC[] = _("Looker's Pokémon");
...
const u8 gText_BattleSpeed4x[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}3x");
...
const u8 gText_SavingPokedex[] = _("Pokémon");
...
const u8 gText_SideQuestName_6[] = _("Bonjour!"); // Bonjour Emma
const u8 gText_SideQuestName_7[] = _("Fish-stery"); // Help Fisherman
const u8 gText_SideQuestName_8[] = _("Eureka!"); // Find battery
const u8 gText_SideQuestName_9[] = _("Enter Stage Right"); // Find and battle idols
const u8 gText_SideQuestName_10[] = _("Pest Control 1"); // Clear pests 1
const u8 gText_SideQuestName_11[] = _("Pest Control 2"); // Clear pests 2
const u8 gText_SideQuestName_12[] = _("Pest Control 3"); // Clear pests 3
const u8 gText_SideQuestName_13[] = _("Forever Faithful"); // Defeat hypnotized man
const u8 gText_SideQuestName_14[] = _("From the Bottom of My Heart"); // Find heart scale
const u8 gText_SideQuestName_15[] = _("I NEED IT"); // Find tasty mint
const u8 gText_SideQuestName_16[] = _("Sent to the Farm"); // Find modern medicine
const u8 gText_SideQuestName_17[] = _("Ancient Remedies"); // Find ancient remedy
const u8 gText_SideQuestName_18[] = _("Forgotten To Time"); // Revive fossil
const u8 gText_SideQuestName_19[] = _("with much gratitude"); // Give a thank you gift to Camilla
const u8 gText_SideQuestName_20[] = _("Opposite Day"); // Inverse battle
const u8 gText_SideQuestName_21[] = _("Break a Leg"); // Idol Gauntlet
const u8 gText_SideQuestName_22[] = _("Lying on the Internet"); // Find a Luxray
const u8 gText_SideQuestName_23[] = _("O Vinnie, Where Art Thou"); // Find the lost Smeargle
const u8 gText_SideQuestName_24[] = _("Pokédex Completion"); // Catch all catchmons
...
const u8 gText_SideQuestName_28[] = _("I Made This"); // Defeat the devs
const u8 gText_SideQuestName_29[] = _("Paradoxical"); // Defeat Looker
const u8 gText_SideQuestName_30[] = _("Unfinished Business"); // Catch the Genies
...
const u8 gText_SideQuestDesc_6[] = _("Hold a conversation with the Kalosian\ntourist!");
const u8 gText_SideQuestDesc_7[] = _("Figure out the best place to fish in\nPorta Bella!");
const u8 gText_SideQuestDesc_8[] = _("Find a way to store the electricity\ngenerated by Mareep!");
const u8 gText_SideQuestDesc_9[] = _("Where did Lisia and her troupe go?\nThe show starts in a few hours!");
const u8 gText_SideQuestDesc_10[] = _("The farm's been overrun with rabbits!\nWon't anybody do something about them?");
const u8 gText_SideQuestDesc_11[] = _("Great, now the farm's been overrun\nwith bugs! Take care of them!");
const u8 gText_SideQuestDesc_12[] = _("Oh no! The mother of all hordes has\noverrun the farm!");
const u8 gText_SideQuestDesc_13[] = _("Find the jealous woman's missing\nboyfriend!");
const u8 gText_SideQuestDesc_14[] = _("Bring the woman something to remind\n her of the Luvdisc hordes!");
const u8 gText_SideQuestDesc_15[] = _("I NEED A TASTY MINT NOOOOOOW!!!!!");
const u8 gText_SideQuestDesc_16[] = _("Find medicine which will work on the\nlivestock of the farm!");
const u8 gText_SideQuestDesc_17[] = _("Bring the old man an ancient medicinal\nherb lost to time!");
const u8 gText_SideQuestDesc_18[] = _("Find a way to revive the fossil!");
const u8 gText_SideQuestDesc_19[] = _("um! i want to give camilla a gift\nbut my parents wont let me leave!");
const u8 gText_SideQuestDesc_20[] = _("The idols are present, but feel thrown\noff! Help them get in the groove!");
const u8 gText_SideQuestDesc_21[] = _("Teach the student type matchups by\nfighting him in an inverse battle!");
const u8 gText_SideQuestDesc_22[] = _("WE CANT SETTLE THIS UNTIL WE SEE\nA LUXRAY! SO BRING US ONE!");
const u8 gText_SideQuestDesc_23[] = _("Nooooo! Vinnie!\nWhere hast thou gone?");
const u8 gText_SideQuestDesc_24[] = _("Catch all the Pokémon of the forest!");
...
const u8 gText_SideQuestDesc_28[] = _("Defeat the developers!");
const u8 gText_SideQuestDesc_29[] = _("Defeat… yourself?");
const u8 gText_SideQuestDesc_30[] = _("Catch the rogue spirits!");
...
const u8 gText_SideQuestDoneDesc_5[] = _("The trainer holding Landorus\ncaptive has released him!"); // Which gym challenger did it?
const u8 gText_SideQuestDoneDesc_6[] = _("Looker can speak French! This might\nbe handy in another adventure…");
const u8 gText_SideQuestDoneDesc_7[] = _("The people of the past now know\nwhere the best fishing spots are!");
const u8 gText_SideQuestDoneDesc_8[] = _("Eureka! The people of the past can\n now harness the power of Mareep!");
const u8 gText_SideQuestDoneDesc_9[] = _("The troupe is reunited! The barista\ngets to keep his job another day!");
const u8 gText_SideQuestDoneDesc_10[] = _("The farm has been cleared of those\npesky rodents!");
const u8 gText_SideQuestDoneDesc_11[] = _("The farm has been cleared again!\nMaybe they should get a guard dog?");
const u8 gText_SideQuestDoneDesc_12[] = _("And again! The farmer has been\nconvinced to get a guard dog!");
const u8 gText_SideQuestDoneDesc_13[] = _("You found the boyfriend captivated by\nthe enchanting spell of Aromatisse!");
const u8 gText_SideQuestDoneDesc_14[] = _("Ahh… The shining scales of the Luvdisc\nare as pretty as she remembers…");
const u8 gText_SideQuestDoneDesc_15[] = _("tasty yum yum tasty mint\nyummy tasty sweet and yummy");
const u8 gText_SideQuestDoneDesc_16[] = _("The livestock appreciated the medicine so\nmuch, one came with you!");
const u8 gText_SideQuestDoneDesc_17[] = _("The man is feeling so chipper, he can\nteach your Pokémon new tricks!");
const u8 gText_SideQuestDoneDesc_18[] = _("The fossil found in the past turned\nout to be related to a modern Pokémon!");
const u8 gText_SideQuestDoneDesc_19[] = _("um, um, um, thanks sir for bringing\n the candies to the future!");
const u8 gText_SideQuestDoneDesc_20[] = _("I guess I really should study the textbook\nfor this test…"); // Inverse
const u8 gText_SideQuestDoneDesc_21[] = _("We're finally ready for our show!\nNo more nerves for us!"); // Break a Leg
const u8 gText_SideQuestDoneDesc_22[] = _("SEE? THATS A LUXRAY!!!");
const u8 gText_SideQuestDoneDesc_23[] = _("O Vinnie, my sweet pupil!\nI'm so glad you're okay!");
const u8 gText_SideQuestDoneDesc_24[] = _("Caught all available Pokémon in the\nPorta Bella Forest!");
...
const u8 gText_SideQuestDoneDesc_28[] = _("I made this");
const u8 gText_SideQuestDoneDesc_29[] = _("The fabric of time and space were,\nthankfully, not ripped apart!");
const u8 gText_SideQuestDoneDesc_30[] = _("The Spirits of Wind and Lightning\nare no match for modernity!");
...
const u8 gText_SideQuestMap6[] = _("Present: Café"); // Fish-stery
const u8 gText_SideQuestMap7[] = _("Past: Outside"); 
const u8 gText_SideQuestMap8[] = _("Past: Outside");
const u8 gText_SideQuestMap9[] = _("Present: Café");
const u8 gText_SideQuestMap10[] = _("Past: Farms");
const u8 gText_SideQuestMap11[] = _("Past: Farms");
const u8 gText_SideQuestMap12[] = _("Past: Farms");
const u8 gText_SideQuestMap13[] = _("Present: Flat 2F");
const u8 gText_SideQuestMap14[] = _("Present: House");
const u8 gText_SideQuestMap15[] = _("Past: House");
const u8 gText_SideQuestMap16[] = _("Past: House");
const u8 gText_SideQuestMap17[] = _("Present: House");
const u8 gText_SideQuestMap18[] = _("Past: Port");
const u8 gText_SideQuestMap19[] = _("Present: Estella's House");
const u8 gText_SideQuestMap20[] = _("Present: Outside");
const u8 gText_SideQuestMap21[] = _("Present: Café");
const u8 gText_SideQuestMap22[] = _("Present: School");
const u8 gText_SideQuestMap23[] = _("Present: Outside");
const u8 gText_SideQuestMap24[] = _("Present: Forest");
const u8 gText_SideQuestMap25[] = _("Map 25");
const u8 gText_SideQuestMap26[] = _("Map 26");
const u8 gText_SideQuestMap27[] = _("Map 27");
const u8 gText_SideQuestMap28[] = _("Present");
const u8 gText_SideQuestMap29[] = _("Past");
const u8 gText_SideQuestMap30[] = _("Present");
...
const u8 gText_SubQuestFindTheCulprit_Desc1[] = _("Defeated Blue!");
const u8 gText_SubQuestFindTheCulprit_Map1[] = _("Present");
const u8 gText_SubQuestFindTheCulprit_Name2[] = _("Defeat May");
const u8 gText_SubQuestFindTheCulprit_Desc2[] = _("Defeated May!");
const u8 gText_SubQuestFindTheCulprit_Map2[] = _("Present");
const u8 gText_SubQuestFindTheCulprit_Name3[] = _("Defeat Katerina");
const u8 gText_SubQuestFindTheCulprit_Desc3[] = _("Defeated Katerina!");
const u8 gText_SubQuestFindTheCulprit_Map3[] = _("Present");
const u8 gText_SubQuestFindTheCulprit_Name4[] = _("Defeat Trey");
const u8 gText_SubQuestFindTheCulprit_Desc4[] = _("Defeated Trey!");
const u8 gText_SubQuestFindTheCulprit_Map4[] = _("Present");
const u8 gText_SubQuestFindTheCulprit_Name5[] = _("Defeat Leaf");
const u8 gText_SubQuestFindTheCulprit_Desc5[] = _("Defeated Leaf!");
const u8 gText_SubQuestFindTheCulprit_Map5[] = _("Present");

const u8 gText_SubQuestCatchTheGenies_Name1[] = _("Catch Tornadus");
const u8 gText_SubQuestCatchTheGenies_Desc1[] = _("I'm sure this won't cause problems!");
const u8 gText_SubQuestCatchTheGenies_Name2[] = _("Catch Thundurus");
const u8 gText_SubQuestCatchTheGenies_Desc2[] = _("I'm sure this won't cause problems!");
const u8 gText_SubQuestCatchTheGenies_Map[] = _("Present");

const u8 gText_SubQuestSaveTheLuvdiscs_Name[] = _("Save the Luvdiscs");
const u8 gText_SubQuestSaveTheLuvdiscs_Desc[] = _("By implementing anti-cruiseline policies,\nthe Luvdiscs were never driven away!");
const u8 gText_SubQuestSaveTheLuvdiscs_Map[] = _("Present");
...
const u8 gText_SubQuestLuxray_Name[] = _("NO WAY!!!");
const u8 gText_SubQuestLuxray_Desc[] = _("THATS A LIE!!!\nLUXRAY CANT BE A DARK TYPE!!!");
const u8 gText_SubQuestLuxray_Map[] = _("Present: School");
...
const u8 gText_SubQuestCatchMons_NameAromatisse[] = _("Aromatisse");
const u8 gText_SubQuestCatchMons_DescAromatisse[] = _("Caught Aromatisse!");
const u8 gText_SubQuestCatchMons_NameCrabominable[] = _("Crabominable");
const u8 gText_SubQuestCatchMons_DescCrabominable[] = _("Caught Crabominable!");
const u8 gText_SubQuestCatchMons_NameDhelmise[] = _("Dhelmise");
const u8 gText_SubQuestCatchMons_DescDhelmise[] = _("Caught Dhelmise!");
const u8 gText_SubQuestCatchMons_NameGrapploct[] = _("Grapploct");
const u8 gText_SubQuestCatchMons_DescGrapploct[] = _("Caught Grapploct!");
const u8 gText_SubQuestCatchMons_NamePalossand[] = _("Palossand");
const u8 gText_SubQuestCatchMons_DescPalossand[] = _("Caught Palossand!");
const u8 gText_SubQuestCatchMons_NamePhione[] = _("Phione");
const u8 gText_SubQuestCatchMons_DescPhione[] = _("Caught the fairy of the sea,\nPhione!");
...
const u8 gText_SubQuestCatchMons_PortMap[] = _("Past: Port");