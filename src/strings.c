...
const u8 gText_SideQuestDesc_6[] = _("Hold a conversation with the Kalos\ntourist!");
...
const u8 gText_SideQuestDesc_19[] = _("um um um! i want to give camilla a gift\nbut my parents wont let me leave!");
...
const u8 gText_SideQuestDesc_22[] = _("WE CANT SETTLE THIS UNTIL WE SEE A LUXRAY!\nSO BRING US ONE!");
