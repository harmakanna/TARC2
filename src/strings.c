...
const u8 gText_SubQuestFindTheCulprit_Name3[] = _("Defeat Ace Trainer");
const u8 gText_SubQuestFindTheCulprit_Desc3[] = _("Defeated the Ace Trainer!");
const u8 gText_SubQuestFindTheCulprit_Map3[] = _("Present");
const u8 gText_SubQuestFindTheCulprit_Name4[] = _("Defeat Youngster");
const u8 gText_SubQuestFindTheCulprit_Desc4[] = _("Defeated the Youngster!");
