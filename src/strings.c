...
const u8 gText_SideQuestName_18[] = _("The Best Time"); // Plant a tree
...
const u8 gText_SideQuestDesc_13[] = _("Bring the woman something to remind\n her of the Luvdisc hordes!");
const u8 gText_SideQuestDesc_14[] = _("no fair! i want a tasty mint!\nwhy do they grow every 100 years!");
const u8 gText_SideQuestDesc_15[] = _("Find medicine which will work on the\nlivestock of the farm!");
const u8 gText_SideQuestDesc_16[] = _("Bring the old man an ancient medicinal\nremedy lost to time!");
const u8 gText_SideQuestDesc_17[] = _("Descripting 17");
const u8 gText_SideQuestDesc_18[] = _("um um um! i want to give camilla a gift\nbut my parents wont let me leave!");
...
const u8 gText_SideQuestDoneDesc_13[] = _("Ahh… The shining scales of the Luvdisc\nare as pretty as she remembers…");
const u8 gText_SideQuestDoneDesc_14[] = _("tasty yum yum tasty mints\nyummy tasty sweet and yummy");
const u8 gText_SideQuestDoneDesc_15[] = _("The livestock appreciated the medicine so\nmuch, one came with you!");
const u8 gText_SideQuestDoneDesc_16[] = _("The man is feeling so chipper, he can\nteach your Pokémon new tricks!");
const u8 gText_SideQuestDoneDesc_17[] = _("Completed Quest 17");
const u8 gText_SideQuestDoneDesc_18[] = _("um, um, um, thanks sir for bringing\ncamilla the candies!");
...
const u8 gText_SideQuestMap18[] = _("Past");
