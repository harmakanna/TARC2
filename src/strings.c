...
const u8 gText_SideQuestName_6[] = _("Fish-stery");
...
const u8 gText_SideQuestDesc_6[] = _("Figure out the best place to fish!");
...
const u8 gText_SideQuestDoneDesc_6[] = _("The people of the past know\nwhere the best fishing spots are!");
...
const u8 gText_SideQuestMap6[] = _("Past"); // Fish-stery
