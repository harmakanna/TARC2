const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_LOOKER] = TRAINER_PIC_LOOKER,
    [FACILITY_CLASS_SCIENTIST] = TRAINER_PIC_SCIENTIST,
    [FACILITY_CLASS_FARMGIRL] = TRAINER_PIC_FARMGIRL,
    [FACILITY_CLASS_IDOL] = TRAINER_PIC_IDOL,
    [FACILITY_CLASS_IDOL2] = TRAINER_PIC_LISIA,
};
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_IDOL] = TRAINER_CLASS_IDOL,
    [FACILITY_CLASS_IDOL2] = TRAINER_CLASS_IDOL2,
