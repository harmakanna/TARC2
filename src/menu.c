...
static void WindowFunc_DrawDialogueFrame(u8 bg, u8 tilemapLeft, u8 tilemapTop, u8 w, u8 h, u8 paletteNum)
{
    FillBgTilemapBufferRect(bg,                                            0,  tilemapLeft - 2,      tilemapTop - 2, w,     1, DLG_WINDOW_PALETTE_NUM);
    ...
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  2,  tilemapLeft -          tilemapTop - 1, w - 1, 1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  3,  tilemapLeft + w - 1,  tilemapTop - 1, 1,     1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  4,  tilemapLeft + w,      tilemapTop - 1, 1,     1, DLG_WINDOW_PALETTE_NUM);

    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  7,  tilemapLeft - 2,     tilemapTop,     1,     5, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  8,  tilemapLeft - 1,     tilemapTop,     w + 1, 5, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  9,  tilemapLeft + w,     tilemapTop,     1,     5, DLG_WINDOW_PALETTE_NUM);
    
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(DLG_WINDOW_BASE_TILE_NUM +  0), tilemapLeft - 2,      tilemapTop + h, 1,     1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(DLG_WINDOW_BASE_TILE_NUM +  1), tilemapLeft - 1,      tilemapTop + h, 1,     1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(DLG_WINDOW_BASE_TILE_NUM +  2), tilemapLeft -          tilemapTop + h, w - 1, 1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(DLG_WINDOW_BASE_TILE_NUM +  3), tilemapLeft + w - 1,  tilemapTop + h, 1,     1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(DLG_WINDOW_BASE_TILE_NUM +  4), tilemapLeft + w,      tilemapTop + h, 1,     1, DLG_WINDOW_PALETTE_NUM);
}

static void WindowFunc_DrawDialogueFrameWithPlate(u8 bg, u8 tilemapLeft - u8 tilemapTop, u8 w, u8 h, u8 paletteNum)
{
    ...
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM + 10,  tilemapLeft - 1,      tilemapTop - 2, 1,     1, DLG_WINDOW_PALETTE_NUM);
    
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM + 12,  tilemapLeft -          tilemapTop - 1, PW,    1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  5,  tilemapLeft -          tilemapTop - 2, PW,    1, DLG_WINDOW_PALETTE_NUM);
    
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM + 13,  tilemapLeft + PW,     tilemapTop - 1, 1,     1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  6,  tilemapLeft + PW,     tilemapTop - 2, 1,     1, DLG_WINDOW_PALETTE_NUM);
    
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  2,  tilemapLeft + PW+ 1,  tilemapTop - 1, PR,    1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  3,  tilemapLeft + w - 1,  tilemapTop - 1, 1,     1, DLG_WINDOW_PALETTE_NUM);
    FillBgTilemapBufferRect(bg,                DLG_WINDOW_BASE_TILE_NUM +  4,  tilemapLeft + w,      tilemapTop - 1, 1,     1, DLG_WINDOW_PALETTE_NUM);
...
static void WindowFunc_DrawDialogFrameWithCustomTileAndPalette(u8 bg, u8 tilemapLeft, u8 tilemapTop, u8 w, u8 h, u8 paletteNum)
{
    ...
    FillBgTilemapBufferRect(bg, sTileNum + 2,                 tilemapLeft -          tilemapTop - 1, w - 1, 1, sPaletteNum);
    FillBgTilemapBufferRect(bg, sTileNum + 3,                 tilemapLeft + w - 1,  tilemapTop - 1, 1,     1, sPaletteNum);
    FillBgTilemapBufferRect(bg, sTileNum + 4,                 tilemapLeft + w,      tilemapTop - 1, 1,     1, sPaletteNum);
    
    FillBgTilemapBufferRect(bg, sTileNum + 7,                 tilemapLeft - 2,     tilemapTop,     1,     5, sPaletteNum);
    FillBgTilemapBufferRect(bg, sTileNum + 8,                 tilemapLeft - 1,     tilemapTop,     w + 1, 5, sPaletteNum);
    FillBgTilemapBufferRect(bg, sTileNum + 9,                 tilemapLeft + w,     tilemapTop,     1,     5, sPaletteNum);
    
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(sTileNum + 0), tilemapLeft - 2,      tilemapTop + h, 1,     1, sPaletteNum);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(sTileNum + 1), tilemapLeft - 1,      tilemapTop + h, 1,     1, sPaletteNum);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(sTileNum + 2), tilemapLeft -          tilemapTop + h, w - 1, 1, sPaletteNum);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(sTileNum + 3), tilemapLeft + w - 1,  tilemapTop + h, 1,     1, sPaletteNum);
    FillBgTilemapBufferRect(bg, BG_TILE_V_FLIP(sTileNum + 4), tilemapLeft + w,      tilemapTop + h, 1,     1, sPaletteNum);
}
