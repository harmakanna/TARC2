...
const u16 gTilesetAnims_CableClub_FloorLight_Frame0[] = INCBIN_U16("data/tilesets/secondary/cable_club/anim/floor_light/0.4bpp");
const u16 gTilesetAnims_CableClub_FloorLight_Frame1[] = INCBIN_U16("data/tilesets/secondary/cable_club/anim/floor_light/1.4bpp");
const u16 gTilesetAnims_CableClub_WallLights_Frame0[] = INCBIN_U16("data/tilesets/secondary/cable_club/anim/wall_lights/0.4bpp");
const u16 gTilesetAnims_CableClub_WallLights_Frame1[] = INCBIN_U16("data/tilesets/secondary/cable_club/anim/wall_lights/1.4bpp");
const u16 gTilesetAnims_CableClub_WallLights_Frame2[] = INCBIN_U16("data/tilesets/secondary/cable_club/anim/wall_lights/2.4bpp");
const u16 gTilesetAnims_CableClub_WallLights_Frame3[] = INCBIN_U16("data/tilesets/secondary/cable_club/anim/wall_lights/3.4bpp");
const u16 tileset_anims_space_12[16] = {};

const u16 *const gTilesetAnims_CableClub_WallLights[] = {
    gTilesetAnims_CableClub_WallLights_Frame0,
    gTilesetAnims_CableClub_WallLights_Frame1,
    gTilesetAnims_CableClub_WallLights_Frame2,
    gTilesetAnims_CableClub_WallLights_Frame3
};

const u16 *const gTilesetAnims_CableClub_FloorLight[] = {
    gTilesetAnims_CableClub_FloorLight_Frame0,
...
static void TilesetAnim_CableClub(u16 timer)
{
    if (timer % 64 == 1)
        QueueAnimTiles_CableClub_GroundLights(timer / 64);
    if (timer % 8 == 1)
        QueueAnimTiles_CableClub_WallLights(timer / 16);
}
...
static void QueueAnimTiles_CableClub_WallLights(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_CableClub_WallLights);
    AppendTilesetAnimToBuffer(gTilesetAnims_CableClub_WallLights[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(NUM_TILES_IN_PRIMARY + 504)), 1 * TILE_SIZE_4BPP);
}

static void QueueAnimTiles_CableClub_GroundLights(u16 timer)
{
    u16 i = timer % ARRAY_COUNT(gTilesetAnims_CableClub_FloorLight);
    AppendTilesetAnimToBuffer(gTilesetAnims_CableClub_FloorLight[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(NUM_TILES_IN_PRIMARY + 480)), 4 * TILE_SIZE_4BPP);
}
