...
static const struct InGameOT sIngameOTs[] =
{
    ...
    [OT_LOOKER_TOXICROAK] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_FAKE_OUT, MOVE_CLOSE_COMBAT, MOVE_SUCKER_PUNCH, MOVE_PROTECT},
        .ball = BALL_CHERISH,
        .nature = NATURE_HASTY,
        .abilityNum = 1,
        .gender = MON_MALE,
    ...
    [OT_PHOEBE_DUSKNOIR] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_PHANTOM_FORCE, MOVE_EARTHQUAKE, MOVE_WILL_O_WISP, MOVE_PROTECT},
        .ball = BALL_LUXURY,
    ...
    [OT_PHOEBE_SABLEYE] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_FAKE_OUT, MOVE_NIGHT_SHADE, MOVE_QUASH, MOVE_PROTECT},
        .ball = BALL_LUXURY,
    ...
    [OT_SHELLY_HUNTAIL] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_DIVE, MOVE_ICE_FANG, MOVE_SUPER_FANG, MOVE_PROTECT},
        .ball = BALL_DIVE,
        .nature = NATURE_JOLLY,
        .abilityNum = 0,
        .gender = MON_MALE,
    ...
    [OT_SHELLY_GOREBYSS] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_SURF, MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_PROTECT},
        .ball = BALL_DIVE,
        .nature = NATURE_TIMID,
        .abilityNum = 0,
        .gender = MON_MALE,
    ...
    [OT_EMMA_MEOWSTIC] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_PSYCHIC, MOVE_CHARGE_BEAM, MOVE_LEER, MOVE_PROTECT},
        .ball = BALL_FRIEND,
    ...
    [OT_LOOKER_YANMEGA] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_AIR_SLASH, MOVE_BUG_BUZZ, MOVE_U_TURN, MOVE_PROTECT},
        .ball = BALL_TIMER,
        .nature = NATURE_TIMID,
        .abilityNum = 0,
        .gender = MON_FEMALE,
    ...
    [OT_LOOKER_MAMOSWINE] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_ICE_SHARD, MOVE_HIGH_HORSEPOWER, MOVE_HEAVY_SLAM, MOVE_PROTECT},
        .ball = BALL_TIMER,
        .nature = NATURE_ADAMANT,
        .abilityNum = 0,
        .gender = MON_MALE,
    ...
    [OT_LOOKER_BRELOOM] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_MACH_PUNCH, MOVE_SEED_BOMB, MOVE_FLING, MOVE_PROTECT},
        .ball = BALL_SAFARI,
        .nature = NATURE_NAIVE,
        .abilityNum = 0,
        .gender = MON_MALE,
    ...
    [OT_LOOKER_SHIINOTIC] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_MOONBLAST, MOVE_GIGA_DRAIN, MOVE_SPORE, MOVE_PROTECT},
        .ball = BALL_SAFARI,
        .nature = NATURE_BOLD,
        .abilityNum = 0,
        .gender = MON_MALE,
    ...
    [OT_TEE_OVERQWIL] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_BARB_BARRAGE, MOVE_THROAT_CHOP, MOVE_TOXIC_SPIKES, MOVE_PROTECT},
        .ball = BALL_NET,
        .nature = NATURE_IMPISH,
        .abilityNum = 1,
        .gender = MON_MALE,
    ...
    [OT_TEE_DRAGALGE] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_DRAGON_PULSE, MOVE_ACID, MOVE_FLIP_TURN, MOVE_PROTECT},
        .ball = BALL_NET,
        .nature = NATURE_CALM,
        .abilityNum = 1,
        .gender = MON_FEMALE,
    ...
    [OT_ALICE_TAUROS] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_RAGING_BULL, MOVE_ZEN_HEADBUTT, MOVE_TRAILBLAZE, MOVE_PROTECT},
        .ball = BALL_HEAL,
        .nature = NATURE_ADAMANT,
        .abilityNum = 0,
        .gender = MON_MALE,
    ...
    [OT_ALICE_MILTANK] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_BODY_SLAM, MOVE_ROLLOUT, MOVE_GROWL, MOVE_PROTECT},
        .ball = BALL_HEAL,
        .nature = NATURE_JOLLY,
        .abilityNum = 0,
        .gender = MON_FEMALE,
    ...
    [OT_PAOLO_GALVANTULA] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_DISCHARGE, MOVE_VOLT_SWITCH, MOVE_BUG_BUZZ, MOVE_PROTECT},
        .ball = BALL_QUICK,
        .nature = NATURE_MODEST,
        .abilityNum = 0,
        .gender = MON_MALE,
    ...
    [OT_PAOLO_PROBOPASS] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_FLASH_CANNON, MOVE_VOLT_SWITCH, MOVE_THUNDER_WAVE, MOVE_PROTECT},
        .ball = BALL_QUICK,
        .nature = NATURE_QUIET,
        .abilityNum = 0,
        .gender = MON_MALE,
    ...
    [OT_MAY_CAMERUPT] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_EARTH_POWER, MOVE_LAVA_PLUME, MOVE_YAWN, MOVE_PROTECT},
        .ball = BALL_HEAVY,
    ...
    [OT_BEATRICE_SWANNA] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_SCALD, MOVE_HURRICANE, MOVE_ALLURING_VOICE, MOVE_PROTECT},
        .ball = BALL_LOVE,
        .nature = NATURE_CALM,
        .abilityNum = 0,
        .gender = MON_FEMALE,
    ...
    [OT_BEATRICE_UNFEZANT] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_QUICK_ATTACK, MOVE_BRAVE_BIRD, MOVE_LEER, MOVE_PROTECT},
        .ball = BALL_LOVE,
        .nature = NATURE_TIMID,
        .abilityNum = 0,
        .gender = MON_FEMALE,
    ...
    [OT_LEO_SMEARGLE] =
    {
        ...
        .ivs = {15, 15, 15, 15, 15, 15}, //HP, Atk, Def, Spe, SpA, SpDef
        .evs = {0, 0, 0, 0, 0, 0}, //HP, Atk, Def, Spe, SpA, SpDef
        .moves = {MOVE_SKETCH, MOVE_SKETCH, MOVE_SKETCH, MOVE_SKETCH},
        .ball = BALL_DREAM,
