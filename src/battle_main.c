...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COOLTRAINER] = { _("Challenger"), 12, BALL_ULTRA },
    ...
    [TRAINER_CLASS_ELITE_FOUR] = { _("Leader"), 25, BALL_LUXURY },
    ...
    [TRAINER_CLASS_YOUNGSTER] = { _("Challenger"), 4 },
    ...
    [TRAINER_CLASS_TRIATHLETE] = { _("Hypnotized"), 10 },
    ...
    [TRAINER_CLASS_COOLTRAINER_2] = { _("Challenger"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("MAGMA ADMIN"), 10 },
    [TRAINER_CLASS_RIVAL] = { _("Challenger"), 15 },
    ...
    [TRAINER_CLASS_SALON_MAIDEN] = { _("Detective") },
    ...
    [TRAINER_CLASS_SCIENTIST] = { _("Relic Maniac") },
    [TRAINER_CLASS_FARMGIRL] = { _("Farm Girl") },
    [TRAINER_CLASS_IDOL] = { _("Idol") },
    [TRAINER_CLASS_IDOL2] = { _("Idol") },
